...
const SlidingImage = ({ images, index }: imageAppProps & { index: number }) => {
  ...
  const profileText = [
    ...
    "I'm the vanilla half of AYCE, but my favorite ice cream flavor is pistachio. My cat whisker collection isn't as good as Sara's, because I'm allergic to cats. I'm a big fan of Arsenal FC, and my support for the Korean National Team brought me D-list celebrity status while I was in Russia and Qatar. I like meeting new people and I'm a self-described golden retriever, which is why I think Sora asked me to co-host. In my spare time you can find me at concerts, spending time with family/friends, and playing golf. I hit a hole in one once - sliced it right into the wrong hole. Does that still count as a hole in one?",
  ];
  const profileName = ['Rob', 'Sara', 'Peter'];

  const igHandle = [
    'https://www.instagram.com/golfmetric/',
    'https://www.instagram.com/aycepod/',
